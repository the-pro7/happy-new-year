...
document.querySelector("#app").innerHTML = `
 <main class="pt-20 flex items-center flex-col relative min-h-screen">
   ...
   <p class="m-10 absolute bottom-0 right-0 lg:m-5">Built by <span class="font-bold bg-gradient-to-tr from-purple-500 to-orange-500 bg-clip-text text-transparent">Emmanuel Opoku-Ameyaw</span> for y'all with 💗</p>
 </main>
`;
